...
rule deeptfactor_to_json:
    ...
    log: "workflow/report/logs/deeptfactor/deeptfactor/deeptfactor-{strains}_to_json.log"
    shell:
        """
...
rule deeptfactor_summary:
    input:
        deeptfactor_json = lambda wildcards: expand("data/interim/deeptfactor/{strains}_deeptfactor.json",
    ...
    conda:
        "../envs/bgc_analytics.yaml"
    log: "workflow/report/logs/deeptfactor/deeptfactor_{name}.log"
    shell:
        """
